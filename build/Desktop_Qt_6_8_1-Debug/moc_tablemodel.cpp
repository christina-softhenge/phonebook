...
static constexpr auto qt_meta_stringdata_ZN10TableModelE = QtMocHelpers::stringData(
    "TableModel"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10TableModelE[] = {
...
Q_CONSTINIT const QMetaObject TableModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10TableModelE.offsetsAndSizes,
    qt_meta_data_ZN10TableModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10TableModelE_t,
        // Q_OBJECT / Q_GADGET
...
void *TableModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10TableModelE.stringdata0))
